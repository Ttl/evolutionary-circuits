...
parts = {'R':{'nodes':2,'value':1,'min':0,'max':6},#Resistors
         'C':{'nodes':2,'value':1,'min':-13,'max':-9},#Capacitors
         #'L':{'nodes':2,'value':1,'min':-9,'max':-3},#No inductors allowed
         'Q1':{'nodes':3,'spice':'2N3904'},#NPN transistors
         'Q2':{'nodes':3,'spice':'2N3906'} #PNP transistors
         }
...
mutation_rate=0.7   #These are default values, feel free to change them if you know better
crossover_rate=0.2  #
